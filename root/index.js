...
mkdir -p src/{components,pages,styles} && mkdir -p prisma && mkdir -p scripts
...
module.exports = client;" > scripts/redisClient.js

# Create a basic OpenAI agent setup
echo "const { OpenAIApi, Configuration } = require('openai');
...
module.exports = openai;" > scripts/openaiClient.js

# Final message
echo "SupportSphere project initialized successfully."